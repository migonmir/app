...
public class Pelicula {
    ...
    private String sinopsis;
      // URL de la imagen de la película (varchar)
    ...
    public Pelicula(int idPelicula,String titulo, String genero, String director, String duracion, String reparto, String sinopsis, String imagen) {
        this.idPelicula = idPelicula;
        this.titulo = titulo;
        this.genero = genero;
