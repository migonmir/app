...
public class Controlador extends HttpServlet { // Declaración de la clase Controlador que extiende HttpServlet
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String query = "INSERT INTO t_peliculas (titulo, genero, director, duracion, reparto, sinopsis, imagen) VALUES (?, ?, ?, ?, ?, ?, ?)";
            ...
            if (rs.next()) {
                int idPeli = rs.getInt(1);  // Obtener el valor del primer campo generado automáticamente (en este caso, el ID)
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String query = "SELECT * FROM t_peliculas";
